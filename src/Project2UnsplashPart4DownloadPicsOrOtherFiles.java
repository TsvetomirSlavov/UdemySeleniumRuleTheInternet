...
/**
 * Java and Selenium Concepts in this class
 * 
 * RegEx, Robot, Actions, File, FirefoxProfile, XPath contains text, LinkedHashSet, Position, Dimention
 */
public class Project2UnsplashPart4DownloadPicsOrOtherFiles {
	...
	public void setup() throws InterruptedException{		
		...
		profile.setPreference("browser.download.dir", "C:\\developer\\workspace\\UdemySeleniumRuleTheInternet\\downloadedPictures");
	...
	public void chechNumberOfFollowers() throws InterruptedException{	
		...
		while(m.find()){
			...
			wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.className("_2rNEa"))));
			WebElement largePicture = driver.findElement(By.className("_2rNEa"));
			action = new Actions(driver);
			action.doubleClick(largePicture).build().perform();
			Thread.sleep(5000);*/
